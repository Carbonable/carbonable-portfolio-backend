...
func (ctd *CustomerTokensDelete) Where(ps ...predicate.CustomerTokens) *CustomerTokensDelete {
...
func (ctd *CustomerTokensDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(customertokens.Table, sqlgraph.NewFieldSpec(customertokens.FieldID, field.TypeInt))
...
type CustomerTokensDeleteOne struct {
	ctd *CustomerTokensDelete
}

// Where appends a list predicates to the CustomerTokensDelete builder.
func (ctdo *CustomerTokensDeleteOne) Where(ps ...predicate.CustomerTokens) *CustomerTokensDeleteOne {
...
func (ctdo *CustomerTokensDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{customertokens.Label}
	default:
		return nil
	}
}
