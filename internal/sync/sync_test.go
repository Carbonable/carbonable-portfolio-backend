...
func TestSynchronizeWithAlreadyExisting(t *testing.T) {
	...
	_ = db.Project.Create().SetAddress("0x00130b5a3035eef0470cff2f9a450a7a6856a3c5a4ea3f5b7886c2d03a50d2bf").SetName("fakename1").SetImage("").SetSlot(1).SetMinterAddress("").SetAbi(model.ProjectAbi{Project: json.RawMessage(`{}`), Minter: json.RawMessage(`{}`)}).SetSlotURI(model.SlotUri{}).SaveX(ctx)
	_ = db.Project.Create().SetAddress("0x00130b5a3035eef0470cff2f9a450a7a6856a3c5a4ea3f5b7886c2d03a50d2bf").SetName("fakename2").SetImage("").SetSlot(2).SetMinterAddress("").SetAbi(model.ProjectAbi{Project: json.RawMessage(`{}`), Minter: json.RawMessage(`{}`)}).SetSlotURI(model.SlotUri{}).SaveX(ctx)
	_ = db.Project.Create().SetAddress("0x00130b5a3035eef0470cff2f9a450a7a6856a3c5a4ea3f5b7886c2d03a50d2bf").SetName("fakename3").SetImage("").SetSlot(3).SetMinterAddress("").SetAbi(model.ProjectAbi{Project: json.RawMessage(`{}`), Minter: json.RawMessage(`{}`)}).SetSlotURI(model.SlotUri{}).SaveX(ctx)
